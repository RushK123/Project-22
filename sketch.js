...
function setup() {
	...
	bob1 = Bodies.circle(50, 200, 10, bobOptions);
	World.add(world, bob1);
	bob2 = Bodies.circle(100, 200, 10, bobOptions);
	World.add(world, bob2);
	bob3 = Bodies.circle(150, 200, 10, bobOptions);
	World.add(world, bob3);
	bob4 = Bodies.circle(200, 200, 10,bobOptions);
	World.add(world, bob4);
	bob5 = Bodies.circle(250, 200, 10, bobOptions);
